...
<div align="center">
<div style="width:850px; height:auto; background:black; padding:0px 0 10px 0; border-radius:10px; -webkit-border-radius:10px;">
<table align="center">
	<tr>
    	<td colspan="5"><font color="white">Pemesan : <?php echo "<input type='text' name='id' value='".$ar_id['id_pembeli']."' />"; ?></td>
    </tr>
	<tr>
    	<td><font color="white">Kode Pesanan</td>
        <td><font color="white">Nama Pesanan</td>
        <td><font color="white">Harga</td>
        <td><font color="white">Jumlah Pesanan</td>
        <td><font color="white">Jumlah Harga</td>
    </tr>
    <?php
		...
		<tr>
			<td colspan='5' align='right'><font color='white'>Tolal Harga : <input type='text' value='Rp.".$arr_hsl['jlh_total']."' /><input type='hidden' name='id' value='".$aidi."' /></td>
		</tr>
		<tr>
