...
$karyawan = mysqli_query($konek, " SELECT * FROM karyawan where id_karyawand='$id_karyawan'");
    ...
    <form action="update_karyawan.php" method="post">
      ...
      <table>
        <tr>
          ...
          <td><input type="text" disabled  value="<?php echo $row['id_karyawan'];?>"/></td>
        </tr>
        <tr>
          <td>Nama Karyawan</td>
          <td>:</td>
          <td><input type="text" name="nama_karyawan" value="<?php echo $row['nama_karyawan'];?>"></td>
        </tr>
        <tr>
          <td>Gmail</td>
          <td>:</td>
          <td><input type="text" name="gmail" value="<?php echo $row['gmail'];?>"></textarea></td>
        </tr>
        <tr>
          <td>User</td>
          <td>:</td>
          <td><input type="text" name="user_karyawan" value="<?php echo $row['user_karyawan'];?>"></td>
        </tr>
        <tr>
          <td>Password</td>
          <td>:</td>
          <td><input type="text" name="pass_karyawan" value="<?php echo $row['pass_karyawan'];?>"></td>
        </tr>
        <tr>
          <td colspan="2"></td>
