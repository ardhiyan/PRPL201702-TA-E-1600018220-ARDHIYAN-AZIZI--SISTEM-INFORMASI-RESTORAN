...
</script><meta name="Description" content="Information architecture, Web Design, Web Standards." />
...
<div id="nav">
<ul>
<li id="current"><a href="/../reszi">Home</a></li>
...
<table align="center">
        ...
        <td id="td"><a href="tambah_barang.html">Tambah Makanan</a></td>
		<td id="td"><a href="beli.php">Order</a></td>
	...
	<td>
			...
			</td><td><input type="submit" value="Search" /></form> </tr></center></td>
<br />
<div style="width:100%">
	<div align="center">
	  ...
	  <center><font size="5">LIST MENU MAKANAN KECIL</center></font>
            <tr id="td">
                <td>No.</td>
                <td>Kode Pemesan</td>
                <td>Nama Pesanan</td>
