...
$sql = "UPDATE customer SET namacustomer='$namacustomer',alamatcustomer='$alamatcustomer',pilihanmakanan='$pilihanmakanan', pilihanminuman='$pilihanminuman' WHERE idcustomer='$idcustomer'";
if($konek->query($sql)){
