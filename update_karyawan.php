...
$sql = "UPDATE karyawan SET nama_karyawan='$nama_karyawan',pass_karyawan='$pass_karyawan',user_karyawan='$user_karyawan', gmail='$gmail' WHERE id_karyawan='$id_karyawan'";
if($konek->query($sql)){
  echo "Data karyawan BERHASIL diedit!<br/>";
}else{
  echo "Data karyawan GAGAL diedit : ".$konek->error."<br/>";
}
...
<li><a href="#TemplateInfo">Profile</a></li>
<li><a href="#SampleTags">Galerry</a></li>
<li><a href="http://www.styleshout.com/">Information</a></li>
<li><a href="http://www.4templates.com/?aff=ealigam">About</a></li>
</ul>
<h3>Links</h3>
<ul class="sidemenu">
...
<p> © 2017 <strong>Your Company</strong> | Design
